...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function xc(){return new In({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wa(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function vc(){return new In({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wa(),fragmentShader:`
	...
	`}function em(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===So||c===wo,h=c===Wi||c===Xi;if(l||h){let f=t.get(a);const u=f!==void 0?f.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==u)return e===null&&(e=new gc(i)),f=l?e.fromEquirectangular(a,f):e.fromCubemap(a,f),f.texture.pmremVersion=a.pmremVersion,t.set(a,f),f.texture;if(f!==void 0)return f.texture;{const p=a.image;return l&&p&&p.height>0||h&&p&&s(p)?(e===null&&(e=new gc(i)),f=l?e.fromEquirectangular(a):e.fromCubemap(a),f.texture.pmremVersion=a.pmremVersion,t.set(a,f),a.addEventListener("dispose",r),f.texture):null}}}return a}function s(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function nm(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&va("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function im(i,t,e,n){const s={},r=new WeakMap;function o(f){const u=f.target;u.index!==null&&t.remove(u.index);for(const g in u.attributes)t.remove(u.attributes[g]);for(const g in u.morphAttributes){const x=u.morphAttributes[g];for(let m=0,d=x.length;m<d;m++)t.remove(x[m])}u.removeEventListener("dispose",o),delete s[u.id];const p=r.get(u);p&&(t.remove(p),r.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,e.memory.geometries--}function a(f,u){return s[u.id]===!0||(u.addEventListener("dispose",o),s[u.id]=!0,e.memory.geometries++),u}function c(f){const u=f.attributes;for(const g in u)t.update(u[g],i.ARRAY_BUFFER);const p=f.morphAttributes;for(const g in p){const x=p[g];for(let m=0,d=x.length;m<d;m++)t.update(x[m],i.ARRAY_BUFFER)}}function l(f){const u=[],p=f.index,g=f.attributes.position;let x=0;if(p!==null){const S=p.array;x=p.version;for(let v=0,y=S.length;v<y;v+=3){const U=S[v+0],C=S[v+1],R=S[v+2];u.push(U,C,C,R,R,U)}}else if(g!==void 0){const S=g.array;x=g.version;for(let v=0,y=S.length/3-1;v<y;v+=3){const U=v+0,C=v+1,R=v+2;u.push(U,C,C,R,R,U)}}else return;const m=new(Ll(u)?Fl:Nl)(u,1);m.version=x;const d=r.get(f);d&&t.remove(d),r.set(f,m)}function h(f){const u=r.get(f);if(u){const p=f.index;p!==null&&u.version<p.version&&l(f)}else l(f);return r.get(f)}return{get:a,update:c,getWireframeAttribute:h}}function sm(i,t,e){let n;function s(u){n=u}let r,o;function a(u){r=u.type,o=u.bytesPerElement}function c(u,p){i.drawElements(n,p,r,u*o),e.update(p,n,1)}function l(u,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,u*o,g),e.update(p,n,g))}function h(u,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,u,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];e.update(m,n,1)}function f(u,p,g,x){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<u.length;d++)l(u[d]/o,p[d],x[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,u,0,x,0,g);let d=0;for(let S=0;S<g;S++)d+=p[S];for(let S=0;S<x.length;S++)e.update(d,n,x[S])}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=f}function rm(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function om(i,t,e){const n=new WeakMap,s=new Ae;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=h!==void 0?h.length:0;let u=n.get(a);if(u===void 0||u.count!==f){let M=function(){I.dispose(),n.delete(a),a.removeEventListener("dispose",M)};var p=M;u!==void 0&&u.texture.dispose();const g=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],S=a.morphAttributes.normal||[],v=a.morphAttributes.color||[];let y=0;g===!0&&(y=1),x===!0&&(y=2),m===!0&&(y=3);let U=a.attributes.position.count*y,C=1;U>t.maxTextureSize&&(C=Math.ceil(U/t.maxTextureSize),U=t.maxTextureSize);const R=new Float32Array(U*C*4*f),I=new Dl(R,U,C,f);I.type=Tn,I.needsUpdate=!0;const E=y*4;for(let P=0;P<f;P++){const q=d[P],H=S[P],Y=v[P],tt=U*C*4*P;for(let K=0;K<q.count;K++){const it=K*E;g===!0&&(s.fromBufferAttribute(q,K),R[tt+it+0]=s.x,R[tt+it+1]=s.y,R[tt+it+2]=s.z,R[tt+it+3]=0),x===!0&&(s.fromBufferAttribute(H,K),R[tt+it+4]=s.x,R[tt+it+5]=s.y,R[tt+it+6]=s.z,R[tt+it+7]=0),m===!0&&(s.fromBufferAttribute(Y,K),R[tt+it+8]=s.x,R[tt+it+9]=s.y,R[tt+it+10]=s.z,R[tt+it+11]=Y.itemSize===4?s.w:1)}}u={count:f,texture:I,size:new dt(U,C)},n.set(a,u),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const x=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",x),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",u.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:r}}function am(i,t,e,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,f=t.get(c,h);if(s.get(f)!==l&&(t.update(f),s.set(f,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const u=c.skeleton;s.get(u)!==l&&(u.update(),s.set(u,l))}return f}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}class Gl extends Ve{constructor(t,e,n,s,r,o,a,c,l,h=Gi){if(h!==Gi&&h!==Yi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Gi&&(n=hi),n===void 0&&h===Yi&&(n=qi),super(null,s,r,o,a,c,h,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:Qe,this.minFilter=c!==void 0?c:Qe,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Vl=new Ve,Mc=new Gl(1,1),Wl=new Dl,Xl=new qu,ql=new zl,yc=[],Sc=[],wc=new Float32Array(16),Ec=new Float32Array(9),bc=new Float32Array(4);function Ji(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=yc[s];if(r===void 0&&(r=new Float32Array(s),yc[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function Ce(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Pe(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Pr(i,t){let e=Sc[t];e===void 0&&(e=new Int32Array(t),Sc[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function cm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function lm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ce(e,t))return;i.uniform2fv(this.addr,t),Pe(e,t)}}function hm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ce(e,t))return;i.uniform3fv(this.addr,t),Pe(e,t)}}function um(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ce(e,t))return;i.uniform4fv(this.addr,t),Pe(e,t)}}function dm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ce(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Pe(e,t)}else{if(Ce(e,n))return;bc.set(n),i.uniformMatrix2fv(this.addr,!1,bc),Pe(e,n)}}function fm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ce(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Pe(e,t)}else{if(Ce(e,n))return;Ec.set(n),i.uniformMatrix3fv(this.addr,!1,Ec),Pe(e,n)}}function pm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ce(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Pe(e,t)}else{if(Ce(e,n))return;wc.set(n),i.uniformMatrix4fv(this.addr,!1,wc),Pe(e,n)}}function mm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function gm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ce(e,t))return;i.uniform2iv(this.addr,t),Pe(e,t)}}function _m(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ce(e,t))return;i.uniform3iv(this.addr,t),Pe(e,t)}}function xm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ce(e,t))return;i.uniform4iv(this.addr,t),Pe(e,t)}}function vm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Mm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ce(e,t))return;i.uniform2uiv(this.addr,t),Pe(e,t)}}function ym(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ce(e,t))return;i.uniform3uiv(this.addr,t),Pe(e,t)}}function Sm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ce(e,t))return;i.uniform4uiv(this.addr,t),Pe(e,t)}}function wm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Mc.compareFunction=Pl,r=Mc):r=Vl,e.setTexture2D(t||r,s)}function Em(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Xl,s)}function bm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||ql,s)}function Tm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Wl,s)}function Am(i){switch(i){case 5126:return cm;case 35664:return lm;case 35665:return hm;case 35666:return um;case 35674:return dm;case 35675:return fm;case 35676:return pm;case 5124:case 35670:return mm;case 35667:case 35671:return gm;case 35668:case 35672:return _m;case 35669:case 35673:return xm;case 5125:return vm;case 36294:return Mm;case 36295:return ym;case 36296:return Sm;case 35678:case 36198:case 36298:case 36306:case 35682:return wm;case 35679:case 36299:case 36307:return Em;case 35680:case 36300:case 36308:case 36293:return bm;case 36289:case 36303:case 36311:case 36292:return Tm}}function Rm(i,t){i.uniform1fv(this.addr,t)}function Cm(i,t){const e=Ji(t,this.size,2);i.uniform2fv(this.addr,e)}function Pm(i,t){const e=Ji(t,this.size,3);i.uniform3fv(this.addr,e)}function Lm(i,t){const e=Ji(t,this.size,4);i.uniform4fv(this.addr,e)}function Im(i,t){const e=Ji(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Dm(i,t){const e=Ji(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Um(i,t){const e=Ji(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Nm(i,t){i.uniform1iv(this.addr,t)}function Fm(i,t){i.uniform2iv(this.addr,t)}function Om(i,t){i.uniform3iv(this.addr,t)}function Bm(i,t){i.uniform4iv(this.addr,t)}function zm(i,t){i.uniform1uiv(this.addr,t)}function km(i,t){i.uniform2uiv(this.addr,t)}function Hm(i,t){i.uniform3uiv(this.addr,t)}function Gm(i,t){i.uniform4uiv(this.addr,t)}function Vm(i,t,e){const n=this.cache,s=t.length,r=Pr(e,s);Ce(n,r)||(i.uniform1iv(this.addr,r),Pe(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||Vl,r[o])}function Wm(i,t,e){const n=this.cache,s=t.length,r=Pr(e,s);Ce(n,r)||(i.uniform1iv(this.addr,r),Pe(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||Xl,r[o])}function Xm(i,t,e){const n=this.cache,s=t.length,r=Pr(e,s);Ce(n,r)||(i.uniform1iv(this.addr,r),Pe(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||ql,r[o])}function qm(i,t,e){const n=this.cache,s=t.length,r=Pr(e,s);Ce(n,r)||(i.uniform1iv(this.addr,r),Pe(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||Wl,r[o])}function Ym(i){switch(i){case 5126:return Rm;case 35664:return Cm;case 35665:return Pm;case 35666:return Lm;case 35674:return Im;case 35675:return Dm;case 35676:return Um;case 5124:case 35670:return Nm;case 35667:case 35671:return Fm;case 35668:case 35672:return Om;case 35669:case 35673:return Bm;case 5125:return zm;case 36294:return km;case 36295:return Hm;case 36296:return Gm;case 35678:case 36198:case 36298:case 36306:case 35682:return Vm;case 35679:case 36299:case 36307:return Wm;case 35680:case 36300:case 36308:case 36293:return Xm;case 36289:case 36303:case 36311:case 36292:return qm}}class Zm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Am(e.type)}}class Km{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Ym(e.type)}}class $m{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const oo=/(\w+)(\])?(\[|\.)?/g;function Tc(i,t){i.seq.push(t),i.map[t.id]=t}function Jm(i,t,e){const n=i.name,s=n.length;for(oo.lastIndex=0;;){const r=oo.exec(n),o=oo.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Tc(e,l===void 0?new Zm(a,i,t):new Km(a,i,t));break}else{let f=e.map[a];f===void 0&&(f=new $m(a),Tc(e,f)),e=f}}}class ur{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);Jm(r,o,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function Ac(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const jm=37297;let Qm=0;function t0(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function e0(i){const t=he.getPrimaries(he.workingColorSpace),e=he.getPrimaries(i);let n;switch(t===e?n="":t===Mr&&e===vr?n="LinearDisplayP3ToLinearSRGB":t===vr&&e===Mr&&(n="LinearSRGBToLinearDisplayP3"),i){case Zn:case Rr:return[n,"LinearTransferOETF"];case Me:case _a:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Rc(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+t0(i.getShaderSource(t),o)}else return s}function n0(i,t){const e=e0(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function i0(i,t){let e;switch(t){case ou:e="Linear";break;case au:e="Reinhard";break;case cu:e="OptimizedCineon";break;case ha:e="ACESFilmic";break;case hu:e="AgX";break;case uu:e="Neutral";break;case lu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function s0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(os).join(`
`)}function r0(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function o0(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function os(i){return i!==""}function Cc(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Pc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const a0=/^[ \t]*#include +<([\w\d./]+)>/gm;function jo(i){return i.replace(a0,l0)}const c0=new Map;function l0(i,t){let e=Zt[t];if(e===void 0){const n=c0.get(t);if(n!==void 0)e=Zt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return jo(e)}const h0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Lc(i){return i.replace(h0,u0)}function u0(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ic(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function d0(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ca?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===la?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===bn&&(t="SHADOWMAP_TYPE_VSM"),t}function f0(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Wi:case Xi:t="ENVMAP_TYPE_CUBE";break;case Ar:t="ENVMAP_TYPE_CUBE_UV";break}return t}function p0(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Xi:t="ENVMAP_MODE_REFRACTION";break}return t}function m0(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case _l:t="ENVMAP_BLENDING_MULTIPLY";break;case su:t="ENVMAP_BLENDING_MIX";break;case ru:t="ENVMAP_BLENDING_ADD";break}return t}function g0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function _0(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=d0(e),l=f0(e),h=p0(e),f=m0(e),u=g0(e),p=s0(e),g=r0(r),x=s.createProgram();let m,d,S=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `}),e=new A(new We(460,32,18),t);return e.renderOrder=-1,e}function T_(){const i=document.createElement("canvas");i.width=256,i.height=128;const t=i.getContext("2d");for(let n=0;n<7;n++){const s=40+Math.random()*176,r=45+Math.random()*40,o=26+Math.random()*34,a=t.createRadialGradient(s,r,0,s,r,o);a.addColorStop(0,"rgba(255,255,255,0.85)"),a.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=a,t.fillRect(0,0,256,128)}const e=new dn(i);return e.colorSpace=Me,e}function A_(i=12){const t=new qt,e=T_();for(let n=0;n<i;n++){const s=new ba({map:e,transparent:!0,opacity:.55+Math.random()*.25,depthWrite:!1}),r=new $l(s);r.scale.set(60+Math.random()*60,22+Math.random()*18,1),r.position.set((Math.random()-.5)*760,120+Math.random()*60,(Math.random()-.5)*760),r.userData.speed=1.2+Math.random()*1.6,t.add(r)}return t}function R_(i,t){for(const e of i.children)e.position.x+=e.userData.speed*t,e.position.x>420&&(e.position.x=-420)}function C_(i){const{renderer:t}=i,e=E_(t),n={tier:e.tier,source:e.source,flags:vs[e.tier],setTier(s){s==="auto"?localStorage.removeItem("gfxTier"):localStorage.setItem("gfxTier",s),location.reload()},demote(){const s=_o.indexOf(n.tier);return s>=_o.length-1?!1:(n.tier=_o[s+1],n.flags=dl(n.tier,i),n.source="probe",!0)},applyResize(){t.setPixelRatio(Math.min(window.devicePixelRatio,n.flags.pixelRatio))}};return t.shadowMap.type=n.flags.softShadow?la:ca,n.flags=dl(n.tier,i),n}const fh=120,ph=45,P_=.35,L_=document.getElementById("app"),Oe=new Yl({antialias:!0});Oe.setSize(window.innerWidth,window.innerHeight);Oe.setPixelRatio(Math.min(window.devicePixelRatio,2));Oe.shadowMap.enabled=!0;Oe.shadowMap.type=la;Oe.toneMapping=ha;Oe.toneMappingExposure=1.15;Oe.outputColorSpace=Me;L_.appendChild(Oe.domElement);const Un=new Zl;Un.background=new Yt(La);Un.fog=new Ea(La,170,480);const en=new $e(75,window.innerWidth/window.innerHeight,.1,600),I_=new ah(14215423,10127984,1.25);Un.add(I_);const fn=new ch(16768944,3.2);fn.position.set(130,190,90);fn.castShadow=!0;fn.shadow.mapSize.set(2048,2048);fn.shadow.camera.left=-160;fn.shadow.camera.right=160;fn.shadow.camera.top=160;fn.shadow.camera.bottom=-160;fn.shadow.camera.far=500;Un.add(fn);const Pn=C_({renderer:Oe,camera:en,scene:Un,sun:fn}),mh=b_(fn.position);Un.add(mh);const Tr=Pn.flags.clouds?A_():null;Tr&&Un.add(Tr);const fi=new qt;Un.add(fi);let ra,gh,qn,_h,Ia,xh,vh,gr,D_;function U_(){fi.traverse(i=>{var e;(e=i.geometry)==null||e.dispose(),(Array.isArray(i.material)?i.material:[i.material]).forEach(n=>{var s;(s=n==null?void 0:n.map)==null||s.dispose(),n==null||n.dispose()})}),fi.clear()}function Mh(){U_(),{colliders:ra,inspectables:gh,targets:qn,waterMeshes:_h,spawnPoint:Ia,cars:xh,pedestrians:vh,traffic:gr,zones:D_}=v_(fi)}Mh();const Ki=new w_(en);Ki.reset(Ia);window.addEventListener("resize",()=>{en.aspect=window.innerWidth/window.innerHeight,en.updateProjectionMatrix(),Oe.setSize(window.innerWidth,window.innerHeight),Pn.applyResize()});const me=i=>document.getElementById(i),Jt={hud:me("hud"),timer:me("timer"),score:me("score"),found:me("found"),crosshair:me("crosshair"),hint:me("hint"),feed:me("feed"),alt:me("alt"),startOverlay:me("startOverlay"),pauseOverlay:me("pauseOverlay"),endOverlay:me("endOverlay"),introOverlay:me("introOverlay"),introGrid:me("introGrid"),introStartBtn:me("introStartBtn"),startBtn:me("startBtn"),resumeBtn:me("resumeBtn"),restartBtn:me("restartBtn"),reviewBtn:me("reviewBtn"),reviewBanner:me("reviewBanner"),finalScore:me("finalScore"),rank:me("rank"),breakdown:me("breakdown")},N_=[{type:"tower",hint:"不鏽鋼水塔沒有頂蓋、看得到水面反光的才是目標；有錐形蓋的是誘餌。",where:"大樓屋頂（要飛到上方看）"},{type:"tarp",hint:"藍白條紋帆布蓋著建材堆，帆布凹陷處積水。",where:"工地圍籬內的地面"},{type:"debris",hint:"廢棄雜物堆旁邊的一灘積水。",where:"廢棄空地（雜草堆、鐵皮圍籬內）、公園角落"},{type:"roofGarden",hint:"整片綠化的空中花園，積水藏在花盆、水桶、澆花器等容器裡。",where:"大樓屋頂（整片綠色的那種）"},{type:"gutter",hint:"屋頂邊緣的長條排水槽，落葉堵塞後積水。",where:"透天厝屋頂的四邊"},{type:"container",hint:"水桶、水盆、輪胎、垃圾桶、保麗龍箱裡的積水。",where:"巷弄、騎樓下，也可能在騎樓遮簷上或高低建築之間的屋簷"}],F_={tower:{pos:[5.5,6.5,5.5],look:[0,3,0]},tarp:{pos:[3.5,3,3.5],look:[0,.7,0]},debris:{pos:[4,3.5,4],look:[0,.5,0]},roofGarden:{pos:[5.2,4.6,5.2],look:[0,.2,0]},gutter:{pos:[3.8,3.4,4.4],look:[0,.4,.6]},container:{pos:[2.6,2.3,2.6],look:[0,.35,0]}};let fl=!1;function O_(){if(fl)return;fl=!0;const i=new Yl({antialias:!0,preserveDrawingBuffer:!0});i.toneMapping=ha,i.toneMappingExposure=1.15,i.setSize(220,150);const t=new Zl;t.background=new Yt(12573934),t.add(new ah(16777215,9080696,1.1));const e=new ch(16773855,2);e.position.set(4,6,3),t.add(e);const n=new A(new de(7,24),new G({color:11049598,roughness:.95}));n.rotation.x=-Math.PI/2,t.add(n);const s=new $e(45,220/150,.1,60);for(const r of N_){const o=M_(r.type);t.add(o);const a=F_[r.type];s.position.set(...a.pos),s.lookAt(...a.look),i.render(t,s);const c=i.domElement.toDataURL("image/png");t.remove(o);const l=Ca[r.type],h=document.createElement("div");h.className="intro-card",h.innerHTML=`
      ...
      </div>`,Jt.introGrid.appendChild(h)}i.dispose()}let He="start",ci=fh,Rn=0,Ms=0,ys=0;function rr(i,t=!1){const e=document.createElement("div");e.className="feed-item"+(t?" bad":""),e.textContent=i,Jt.feed.appendChild(e),setTimeout(()=>e.remove(),4200)}function Ss(){Jt.timer.textContent=ci.toFixed(1),Jt.timer.classList.toggle("urgent",ci<=10),Jt.score.textContent=Rn,Jt.found.textContent=`${Ms} / ${qn.length}`,Jt.alt.textContent=`高度 ${en.position.y.toFixed(0)} m`}function Da(){Oe.domElement.requestPointerLock()}Jt.startBtn.addEventListener("click",()=>{Jt.startOverlay.classList.add("hidden"),O_(),Jt.introOverlay.classList.remove("hidden")});Jt.introStartBtn.addEventListener("click",()=>{Jt.introOverlay.classList.add("hidden"),Jt.hud.classList.remove("hidden"),He="playing",Da()});Jt.resumeBtn.addEventListener("click",()=>{Jt.pauseOverlay.classList.add("hidden"),He="playing",Da()});Jt.restartBtn.addEventListener("click",()=>wh());Jt.reviewBtn.addEventListener("click",()=>{He="review",Jt.endOverlay.classList.add("hidden"),Jt.hud.classList.remove("hidden"),Jt.reviewBanner.classList.remove("hidden"),Da()});document.addEventListener("pointerlockchange",()=>{const i=document.pointerLockElement===Oe.domElement;Ki.enabled=i,!i&&He==="playing"&&(He="paused",Jt.pauseOverlay.classList.remove("hidden")),!i&&He==="review"&&(He="ended",Jt.reviewBanner.classList.add("hidden"),Jt.hud.classList.add("hidden"),Jt.endOverlay.classList.remove("hidden"))});const pl=new Dg,B_=new dt(0,0);function yh(){pl.setFromCamera(B_,en);const i=gh.filter(e=>!e.userData.inspect.done),t=pl.intersectObjects(i,!1);return t.length>0?t[0]:null}window.addEventListener("mousedown",i=>{if(He!=="playing"||i.button!==0||ys>0||document.pointerLockElement!==Oe.domElement)return;ys=P_;const t=yh();if(!t)return;if(t.distance>ph){rr("距離太遠，飛近一點再標記！",!0);return}const e=t.object.userData.inspect;e.done=!0;const n=new D;if(e.group.getWorldPosition(n),e.kind==="target"){e.found=!0,Rn+=e.points,Ms++,rr(`✔ 發現${e.label}！ +${e.points} 分`);const s=ll(!0);if(s.position.copy(n),fi.add(s),Ms===qn.length){const r=Math.floor(ci*2);Rn+=r,rr(`🏆 全數找到！剩餘時間獎勵 +${r} 分`),Sh()}}else{Rn=Math.max(0,Rn-5),rr("✘ 誤報！這裡沒有積水 −5 分",!0);const s=ll(!1);s.position.copy(n),fi.add(s)}Ss()});function Sh(){if(He==="ended")return;He="ended",document.exitPointerLock(),Jt.hud.classList.add("hidden"),Jt.pauseOverlay.classList.add("hidden"),Jt.finalScore.textContent=`${Rn} 分`,Jt.rank.textContent=z_(Rn);const i=[];for(const[t,e]of Object.entries(Ca)){const n=qn.filter(r=>r.type===t),s=n.filter(r=>r.found);i.push(`${e.label}（+${e.points}）：找到 ${s.length} / ${n.length} 處`)}i.push(`合計發現積水：${Ms} / ${qn.length} 處`),Jt.breakdown.innerHTML=i.join("<br>"),Jt.endOverlay.classList.remove("hidden");for(const t of qn){if(t.found)continue;const e=y_(`${t.label} +${t.points}`),n=new D;t.group.getWorldPosition(n),e.position.copy(n),fi.add(e)}}function wh(){Mh(),Ki.reset(Ia),He="start",ci=fh,Rn=0,Ms=0,ys=0,Jt.feed.innerHTML="",Jt.endOverlay.classList.add("hidden"),Jt.pauseOverlay.classList.add("hidden"),Jt.introOverlay.classList.add("hidden"),Jt.reviewBanner.classList.add("hidden"),Jt.hud.classList.add("hidden"),Jt.startOverlay.classList.remove("hidden"),Ss()}function z_(i){return i>=450?"🏅 傳說巡檢無人機！台南市長頒獎表揚！":i>=320?"🥇 金牌巡檢員：登革熱病媒蚊聞風喪膽":i>=200?"🥈 銀牌巡檢員：眼力過人":i>=100?"🥉 銅牌巡檢員：再接再厲":"📋 見習巡檢員：多注意屋頂與空地喔"}const ml=new Ig,xo=.55,vo=.5;let oa=null;const gl=new URLSearchParams(location.search).has("freeze"),li=[];function Eh(){requestAnimationFrame(Eh);const i=ml.getDelta(),t=Math.min(i,.05),e=ml.elapsedTime;if(li.push(i),li.length>120&&li.shift(),_h.forEach((n,s)=>{n.material.emissiveIntensity=oa==="max"?xo+vo:oa==="min"?xo-vo:xo+vo*Math.sin(e*4+s*1.7)}),mh.position.set(en.position.x,0,en.position.z),Tr&&!gl&&R_(Tr,t),He!=="paused"&&!gl&&(Kg(gr,t),jg(xh,t,gr),Jg(vh,t,gr)),He==="playing"){ci-=i,ys=Math.max(0,ys-i),ci<=0&&(ci=0,Sh()),Ki.update(t,ra);const n=yh(),s=n&&n.distance<=ph;Jt.crosshair.classList.toggle("lock",!!s),Jt.hint.classList.toggle("hidden",!s),Ss()}else He==="review"&&(Ki.update(t,ra),Ss());Oe.render(Un,en)}const bh=me("gfxRow");function Th(){me("gfxCurrent").textContent=`目前：${vs[Pn.tier].label}${Pn.source==="probe"?"（自動降級）":""}`;const i=new URLSearchParams(location.search).get("gfx")||localStorage.getItem("gfxTier")||"auto";bh.querySelectorAll(".gfx-btn").forEach(t=>t.classList.toggle("active",t.dataset.gfx===i))}bh.addEventListener("click",i=>{var n;const t=(n=i.target.closest(".gfx-btn"))==null?void 0:n.dataset.gfx;if(!t)return;const e=localStorage.getItem("gfxTier")||"auto";t!==e&&Pn.setTier(t)});Th();setTimeout(()=>{if(Pn.source==="url"||Pn.source==="saved")return;li.length/Math.max(1e-6,li.reduce((t,e)=>t+e,0))<45&&Pn.demote()&&Th()},3500);Ss();Eh();window.__game={camera:en,targets:qn,getScore:()=>Rn,getState:()=>He,getTargets:()=>qn,setPose:(i,t,e,n,s,r)=>{en.position.set(i,t,e),en.lookAt(n,s,r),Ki.velocity.set(0,0,0)},setWaterPhase:i=>{oa=i},getFrameStats:()=>({fps:li.length/Math.max(1e-6,li.reduce((i,t)=>i+t,0)),calls:Oe.info.render.calls,triangles:Oe.info.render.triangles}),restart:()=>wh(),gfx:Pn};
